...
async function sendLoginNotification(user, clientInfo) {
    try {
...
router.post('/login', loginLimiter, async (req, res) => {
    try {
        ...
        sendLoginNotification(user, clientInfo).catch(err => console.error('[security] Login notification failed:', err));
